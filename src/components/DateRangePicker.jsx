...
export default class DateRangePicker extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    // A bug in airbnb date picker when we have first date, and change endDate, the startDate changes to beginning of month
    // So we clear date picker for this case
    // TODO needs proper investigation and fix
    if (nextProps.focusedInput  && this.props.focusedInput === null && nextProps.startDate && nextProps.endDate) {
